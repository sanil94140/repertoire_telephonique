...
<body>
    <div class="container">
        <h1 class="display-4 text-center">Modification des données du contact</h1>
...
<form method="POST" action="" enctype="multipart/form-data" class="p-5">
            ...
            <button name="btn-valider" type="submit" class="btn btn-primary">Modifier l'article</button>
        </form>
